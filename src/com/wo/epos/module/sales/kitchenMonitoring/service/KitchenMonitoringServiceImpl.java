...
@ManagedBean(name="kitchenMonitoringService")
@ViewScoped
public class KitchenMonitoringServiceImpl implements KitchenMonitoringService, Serializable{
	...
	@Override
	public void updateKitchenMonitoring(
		...
		try{
			for(SalesOrderDtlVO dtlVo : salesOrderDtlVoList){
			     ...
			     salesOrderDtl = salesOrderDtlDAO.findById(dtlVo.getSoDtlId());
