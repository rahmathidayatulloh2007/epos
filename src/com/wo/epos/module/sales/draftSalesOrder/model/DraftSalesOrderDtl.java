...
public class DraftSalesOrderDtl  extends BaseEntity implements Serializable{
    ...
    private DraftSalesOrder draftSalesOrder;
	...
	public DraftSalesOrder getDraftSalesOrder() {
		return draftSalesOrder;
	}
	public void setDraftSalesOrder(DraftSalesOrder draftSalesOrder) {
		this.draftSalesOrder = draftSalesOrder;
	}
