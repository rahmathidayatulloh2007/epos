...
@ManagedBean(name="salesOrderFnBService")
@ViewScoped
public class SalesOrderFnBServiceImpl implements SalesOrderFnBService, Serializable{
    ...
    private SalesOrder updateSoPayment(SalesOrderVO salesOrderVO, String user){
    	SalesOrder soHeader = new SalesOrder();
		soHeader = salesOrderDAO.findById(salesOrderVO.getSoId());
		soHeader.setStatusCode(salesOrderVO.getStatusCode());
