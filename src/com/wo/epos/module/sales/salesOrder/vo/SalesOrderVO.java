...
public class SalesOrderVO extends BaseEntity implements Serializable {
	
    private static final long serialVersionUID = 4748121427832625402L;
    ...
    private Double sumTotalNoPpn;
    
    private List<SalesOrderDtlVO> salesOrderDtlVoList = new ArrayList<SalesOrderDtlVO>();
    private List<SalesOrderDtlVO> tagihanList = new ArrayList<SalesOrderDtlVO>();
	...
	public List<SalesOrderDtlVO> getTagihanList() {
		return tagihanList;
	}

	public void setTagihanList(List<SalesOrderDtlVO> tagihanList) {
